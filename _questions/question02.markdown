...
![]({{ 'assets/images/question02/1.png' | relative_url }}) *Activities: Isochrones, Morphological areas*
...
![]({{ 'assets/images/question02/2.png' | relative_url }}) *Activities: Isochrones, Morphological areas*
...
![]({{ 'assets/images/question02/3.png' | relative_url }}) *Activities: Isochrones, Morphological areas, Mapathon, Public transport analysis*
...
![]({{ 'assets/images/question02/4.png' | relative_url }}) *Activities: Isochrones, Morphological areas, Accessibility to public transport stops, Public transport analysis, OD Matrices, OD Matrices with time, Bus stops waiting times*
